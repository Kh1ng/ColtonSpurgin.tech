...
export class SocialsComponent implements OnInit {
  ...
  tiles: Tile[] = [
    ...
    {label: 'Bio + Pics', cols: 3, rows: 3, color: 'lightpink', content: `    Hello and welcome to my online portfolio, I have various school assignments, personal projects and some information about me and my
    ...
    {label: 'Work&Skills', cols: 1, rows: 6, color: 'lightgreen', content: "Work, Skills, Education"},

    {label: 'Four', cols: 3, rows: 1, color: '#DDBDF1', content: "kjhkljfhgjlf"},
